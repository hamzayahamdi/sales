...
var require_vanta_globe_min = __commonJS({
  "node_modules/vanta/dist/vanta.globe.min.js"(exports, module) {
    !function(t, e) {
      ...
      var t = { d: (e2, s2) => {
        for (var i2 in s2)
          t.o(s2, i2) && !t.o(e2, i2) && Object.defineProperty(e2, i2, { enumerable: true, get: s2[i2] });
      ...
      function o(t2) {
        for (; t2.children && t2.children.length > 0; )
          o(t2.children[0]), t2.remove(t2.children[0]);
      ...
      h.VantaBase = class {
        constructor(t2 = {}) {
          ...
          if (this.options = Object.assign({ mouseControls: true, touchControls: true, gyroControls: false, minHeight: 200, minWidth: 200, scale: 1, scaleMobile: 1 }, e2), (t2 instanceof HTMLElement || "string" == typeof t2) && (t2 = { el: t2 }), Object.assign(this.options, t2), this.options.THREE && (r = this.options.THREE), this.el = this.options.el, null == this.el)
            a('Instance needs "el" param!');
          else if (!(this.options.el instanceof HTMLElement)) {
            const t3 = this.el;
            if (this.el = (s2 = t3, document.querySelector(s2)), !this.el)
              return void a("Cannot find element", t3);
          }
          var s2, i2;
