...
var require_vanta_cells_min = __commonJS({
  "node_modules/vanta/dist/vanta.cells.min.js"(exports, module) {
    !function(e, t) {
      ...
      var e = { d: (t2, i2) => {
        for (var o2 in i2)
          e.o(i2, o2) && !e.o(t2, o2) && Object.defineProperty(t2, o2, { enumerable: true, get: i2[o2] });
      }, o: (e2, t2) => Object.prototype.hasOwnProperty.call(e2, t2), r: (e2) => {
        "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e2, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e2, "__esModule", { value: true });
      } }, t = {};
      e.r(t), e.d(t, { default: () => c }), Number.prototype.clamp = function(e2, t2) {
        return Math.min(Math.max(this, e2), t2);
      };
      function i(e2) {
        for (; e2.children && e2.children.length > 0; )
          i(e2.children[0]), e2.remove(e2.children[0]);
        ...
        constructor(e2 = {}) {
          ...
          if (this.options = Object.assign({ mouseControls: true, touchControls: true, gyroControls: false, minHeight: 200, minWidth: 200, scale: 1, scaleMobile: 1 }, t2), (e2 instanceof HTMLElement || "string" == typeof e2) && (e2 = { el: e2 }), Object.assign(this.options, e2), this.options.THREE && (s = this.options.THREE), this.el = this.options.el, null == this.el)
            ...
            if (this.el = (i2 = e3, document.querySelector(i2)), !this.el)
              return void r("Cannot find element", e3);
          }
          var i2, h2;
      ...
      class l extends h {
        ...
        updateUniforms() {
          ...
          for (t2 in this.options)
            i2 = this.options[t2], -1 !== t2.toLowerCase().indexOf("color") ? e2[t2] = { type: "v3", value: new a.Color(i2).toVector() } : "number" == typeof i2 && (e2[t2] = { type: "f", value: i2 });
