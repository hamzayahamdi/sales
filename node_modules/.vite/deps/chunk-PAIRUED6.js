...
var Slide = React2.forwardRef(function Slide2(props, ref) {
  ...
  const childrenRef = React2.useRef(null);
...
var SwipeArea = React4.forwardRef(function SwipeArea2(props, ref) {
  const {
    anchor,
    classes = {},
    className,
  ...
  return (0, import_jsx_runtime4.jsx)(SwipeAreaRoot, _extends({
...
true ? SwipeArea.propTypes = {
   ...
   */
  anchor: import_prop_types4.default.oneOf(["left", "top", "right", "bottom"]).isRequired,
  /**
   * @ignore
   */
...
var SwipeableDrawer = React5.forwardRef(function SwipeableDrawer2(inProps, ref) {
  const props = useDefaultProps({
  ...
  const [maybeSwiping, setMaybeSwiping] = React5.useState(false);
  const swipeInstance = React5.useRef({
    isSwiping: null
  });
  const swipeAreaRef = React5.useRef();
  const backdropRef = React5.useRef();
  const paperRef = React5.useRef();
  const handleRef = useForkRef_default(PaperProps.ref, paperRef);
  const touchDetected = React5.useRef(false);
  const calculatedDurationRef = React5.useRef();
  useEnhancedEffect_default2(() => {
    calculatedDurationRef.current = null;
  }, [open]);
  const setPosition = React5.useCallback((translate, options = {}) => {
    const {
      mode = null,
  ...
  return (0, import_jsx_runtime6.jsxs)(React5.Fragment, {
    children: [(0, import_jsx_runtime5.jsx)(Drawer_default, _extends({
      ...
      onClose,
      ref
    }, other)), !disableSwipeToOpen && variant === "temporary" && (0, import_jsx_runtime5.jsx)(NoSsr_default, {
      children: (0, import_jsx_runtime5.jsx)(SwipeArea_default, _extends({
        anchor,
        ref: swipeAreaRef,
...
true ? SwipeableDrawer.propTypes = {
   ...
   * @default false
   */
  allowSwipeInChildren: import_prop_types5.default.oneOfType([import_prop_types5.default.func, import_prop_types5.default.bool]),
  /**
   * @ignore
   */
   ...
   * @default false
   */
  disableBackdropTransition: import_prop_types5.default.bool,
  /**
   * If `true`, touching the screen near the edge of the drawer will not slide in the drawer a bit
   * to promote accidental discovery of the swipe gesture.
   * @default false
   */
  disableDiscovery: import_prop_types5.default.bool,
  /**
   * If `true`, swipe to open is disabled. This is useful in browsers where swiping triggers
   * navigation actions. Swipe to open is disabled on iOS browsers by default.
   * @default typeof navigator !== 'undefined' && /iPad|iPhone|iPod/.test(navigator.userAgent)
   */
  disableSwipeToOpen: import_prop_types5.default.bool,
  /**
   * @ignore
   */
   ...
   * @default 0.52
   */
  hysteresis: import_prop_types5.default.number,
  /**
   ...
   * @default 450
   */
  minFlingVelocity: import_prop_types5.default.number,
  /**
   * @ignore
   */
  ModalProps: import_prop_types5.default.shape({
    BackdropProps: import_prop_types5.default.shape({
   ...
   */
  SwipeAreaProps: import_prop_types5.default.object,
  /**
   * The width of the left most (or right most) area in `px` that
   * the drawer can be swiped open from.
   * @default 20
   */
  swipeAreaWidth: import_prop_types5.default.number,
  /**
   * The duration for the transition, in milliseconds.
   * You may specify a single timeout for all transitions, or individually with an object.
   * @default {
...
//# sourceMappingURL=chunk-PAIRUED6.js.map
