    ...
    !function(t, e) {
      ...
      function r(t2) {
        for (; t2.children && t2.children.length > 0; )
          r(t2.children[0]), t2.remove(t2.children[0]);
      ...
      l.VantaBase = class {
        constructor(t2 = {}) {
          ...
          if (this.options = Object.assign({ mouseControls: true, touchControls: true, gyroControls: false, minHeight: 200, minWidth: 200, scale: 1, scaleMobile: 1 }, e2), (t2 instanceof HTMLElement || "string" == typeof t2) && (t2 = { el: t2 }), Object.assign(this.options, t2), this.options.THREE && (a = this.options.THREE), this.el = this.options.el, null == this.el)
            c('Instance needs "el" param!');
          else if (!(this.options.el instanceof HTMLElement)) {
            const t3 = this.el;
            if (this.el = (i2 = t3, document.querySelector(i2)), !this.el)
              return void c("Cannot find element", t3);
          }
          var i2, s2;
        ...
        prepareEl() {
          ...
          if ("undefined" != typeof Node && Node.TEXT_NODE)
            for (t2 = 0; t2 < this.el.childNodes.length; t2++) {
          ...
          for (t2 = 0; t2 < this.el.children.length; t2++)
            e2 = this.el.children[t2], "static" === getComputedStyle(e2).position && (e2.style.position = "relative"), "auto" === getComputedStyle(e2).zIndex && (e2.style.zIndex = 1);
      ...
      class u extends p {
        ...
        genRing(t2, e2, i2, r2, h2, a2, l2) {
          ...
          if (f.rotation.x = Math.PI / 2, f.rotation.z = r2, f.position.y = a2, f.speed = 1e-3 * l2, f.receiveShadow = true, f.castShadow = true, this.rings.push(f), this.cont.add(f), e2 < 20 && h2 < 1.3 * Math.PI && n(0, 2))
            try {
        ...
        onUpdate() {
          ...
          for (let t3 of Array.from(null != this.rings ? this.rings : []))
            t3.rotation.z += t3.speed;
