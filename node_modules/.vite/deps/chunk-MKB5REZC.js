...
var useDesktopRangePicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime.jsxs)(PickersProvider, {
    contextValue,
    localeText,
    children: [(0, import_jsx_runtime.jsx)(Field, _extends({}, enrichedFieldProps)), (0, import_jsx_runtime.jsx)(PickersPopper, _extends({
      role: "tooltip",
...
// node_modules/@mui/x-date-pickers-pro/DesktopDateRangePicker/DesktopDateRangePicker.js
var DesktopDateRangePicker = React2.forwardRef(function DesktopDateRangePicker2(inProps, ref) {
  var _a;
...
var DateRangePicker = React3.forwardRef(function DateRangePicker2(inProps, ref) {
  ...
  if (isDesktop) {
    return (0, import_jsx_runtime2.jsx)(DesktopDateRangePicker, _extends({
      ref
    }, other));
  }
  return (0, import_jsx_runtime2.jsx)(MobileDateRangePicker, _extends({
    ref
  }, other));
});
true ? DateRangePicker.propTypes = {
   ...
   * @default 1
   */
  currentMonthCalendarPosition: import_prop_types2.default.oneOf([1, 2, 3]),
  /**
   * Formats the day of week displayed in the calendar header.
   * @param {TDate} date The date of the day of week provided by the adapter.
   * @returns {string} The name to display.
   ...
   * @default 'start'
   */
  defaultRangePosition: import_prop_types2.default.oneOf(["end", "start"]),
  /**
   * The default value.
   * Used when the component is not controlled.
   */
   ...
   * @default false
   */
  disableDragEditing: import_prop_types2.default.bool,
  /**
   * If `true`, disable values after the current date for date components, time for time components and both for date time components.
   * @default false
   */
   ...
   * @param {RangePosition} rangePosition The new range position.
   */
  onRangePositionChange: import_prop_types2.default.func,
  /**
   * Callback fired when the selected sections change.
   * @param {FieldSelectedSections} newValue The new selected sections.
   */
   ...
   * Used when the component position is controlled.
   */
  rangePosition: import_prop_types2.default.oneOf(["end", "start"]),
...
//# sourceMappingURL=chunk-MKB5REZC.js.map
