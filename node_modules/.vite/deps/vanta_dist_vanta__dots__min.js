    ...
    !function(t, e) {
      ...
      function s(t2) {
        for (; t2.children && t2.children.length > 0; )
          s(t2.children[0]), t2.remove(t2.children[0]);
      ...
      r.VantaBase = class {
        constructor(t2 = {}) {
          ...
          if (this.options = Object.assign({ mouseControls: true, touchControls: true, gyroControls: false, minHeight: 200, minWidth: 200, scale: 1, scaleMobile: 1 }, e2), (t2 instanceof HTMLElement || "string" == typeof t2) && (t2 = { el: t2 }), Object.assign(this.options, t2), this.options.THREE && (n = this.options.THREE), this.el = this.options.el, null == this.el)
            h('Instance needs "el" param!');
          else if (!(this.options.el instanceof HTMLElement)) {
            const t3 = this.el;
            if (this.el = (i2 = t3, document.querySelector(i2)), !this.el)
              return void h("Cannot find element", t3);
          }
          var i2, s2;
      ...
      class c extends a {
        ...
        onInit() {
          ...
          const p = [];
          for (e2 = o2 = -30; o2 <= 30; e2 = ++o2)
            for (s2 = n2 = -30; n2 <= 30; s2 = ++n2)
              (r2 = new l.Vector3()).x = e2 * d2 + d2 / 2, r2.y = i(0, 5) - 150, r2.z = s2 * d2 + d2 / 2, p.push(r2);
