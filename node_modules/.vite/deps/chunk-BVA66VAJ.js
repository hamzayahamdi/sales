...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime7.jsxs)(React22.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime7.jsxs)(React22.Fragment, {
  ...
  const Grid2 = React25.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime9.jsx)(GridRoot, _extends({
      ...
      children: React25.Children.map(children, (child) => {
        if (React25.isValidElement(child) && isMuiElement2(child, ["Grid"])) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BVA66VAJ.js.map
