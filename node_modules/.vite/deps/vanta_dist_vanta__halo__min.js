    ...
    !function(e, t) {
      ...
      s.VantaBase = class {
        constructor(e2 = {}) {
          ...
          if (this.options = Object.assign({ mouseControls: true, touchControls: true, gyroControls: false, minHeight: 200, minWidth: 200, scale: 1, scaleMobile: 1 }, t2), (e2 instanceof HTMLElement || "string" == typeof e2) && (e2 = { el: e2 }), Object.assign(this.options, e2), this.options.THREE && (o = this.options.THREE), this.el = this.options.el, null == this.el)
      ...
      class h extends a {
        ...
        updateUniforms() {
          ...
          for (t2 in this.options)
            i2 = this.options[t2], -1 !== t2.toLowerCase().indexOf("color") ? e2[t2] = { type: "v3", value: new c.Color(i2).toVector() } : "number" == typeof i2 && (e2[t2] = { type: "f", value: i2 });
