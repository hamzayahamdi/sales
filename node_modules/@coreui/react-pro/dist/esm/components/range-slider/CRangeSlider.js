import { __rest, __assign, __spreadArray } from '../../packages/coreui-react-pro/node_modules/tslib/tslib.es6.js';
...
var CRangeSlider = forwardRef(function (_a, ref) {
    ...
    var _p = useState(0), dragIndex = _p[0], setDragIndex = _p[1];
    var _q = useState(), thumbSize = _q[0], setThumbSize = _q[1];
    useEffect(function () {
        ...
        React.createElement("div", { className: "range-slider-inputs-container", onMouseDown: handleInputsContainerMouseDown },
            currentValue.map(function (value, index) { return (React.createElement(React.Fragment, { key: index },
                ...
                tooltips && (React.createElement("div", __assign({ className: "range-slider-tooltip" }, (thumbSize && {
                    style: calculateTooltipPosition(min, max, value, thumbSize, vertical, isRTL(rangeSliderRef.current)),
                })),
            ...
            React.createElement("div", __assign({ className: "range-slider-track" }, (track && { style: updateGradient(min, max, currentValue, vertical) }), { ref: trackRef }))),
        labels && (React.createElement("div", { className: "range-slider-labels-container", ref: labelsContainerRef }, Array.isArray(labels) &&
            labels.map(function (label, index) {
                ...
                return (React.createElement("div", { className: classNames('range-slider-label', {
                    ...
                    }, typeof label === 'object' && 'className' in label && label.className), style: labelStyle, onMouseDown: function () { return handleLabelClick(labelValue); }, key: index, ref: function (el) {
