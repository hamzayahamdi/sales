...
var CMultiSelectNativeSelect = forwardRef(function (_a, ref) {
    var id = _a.id, name = _a.name, options = _a.options, rest = __rest(_a, ["id", "name", "options"]);
    return (React.createElement("select", __assign({ id: id }, (id && !name && { name: "".concat(id, "-multi-select") }), (name && { name: name }), { tabIndex: -1, style: { display: 'none' } }, rest, { ref: ref }), options && createNativeOptions(options)));
});
