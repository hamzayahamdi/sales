...
var CRangeSlider = React.forwardRef(function (_a, ref) {
    ...
    var _p = React.useState(0), dragIndex = _p[0], setDragIndex = _p[1];
    var _q = React.useState(), thumbSize = _q[0], setThumbSize = _q[1];
    ...
    var handleInputsContainerMouseDown = function (event) {
        ...
        var clickValue = utils.calculateClickValue(event, trackRef.current, min, max, step, vertical, isRTL.default(rangeSliderRef.current));
        var index = utils.getNearestValueIndex(clickValue, currentValue);
        setIsDragging(true);
        setDragIndex(index);
        updateNearestValue(clickValue);
    };
    var handleLabelClick = function (value) {
    ...
    var handleMouseMove = function (event) {
        ...
        var moveValue = utils.calculateMoveValue(event, trackRef.current, min, max, step, vertical, isRTL.default(rangeSliderRef.current));
        ...
        React.createElement("div", { className: "range-slider-inputs-container", onMouseDown: handleInputsContainerMouseDown },
            currentValue.map(function (value, index) { return (React.createElement(React.Fragment, { key: index },
                ...
                tooltips && (React.createElement("div", tslib_es6.__assign({ className: "range-slider-tooltip" }, (thumbSize && {
                    style: utils.calculateTooltipPosition(min, max, value, thumbSize, vertical, isRTL.default(rangeSliderRef.current)),
                })),
            ...
            React.createElement("div", tslib_es6.__assign({ className: "range-slider-track" }, (track && { style: utils.updateGradient(min, max, currentValue, vertical) }), { ref: trackRef }))),
        labels && (React.createElement("div", { className: "range-slider-labels-container", ref: labelsContainerRef }, Array.isArray(labels) &&
            labels.map(function (label, index$1) {
                ...
                return (React.createElement("div", { className: index.default('range-slider-label', {
                    ...
                    }, typeof label === 'object' && 'className' in label && label.className), style: labelStyle, onMouseDown: function () { return handleLabelClick(labelValue); }, key: index$1, ref: function (el) {
