...
var CWidgetStatsD = React.forwardRef(function (_a, ref) {
    var _b;
    var className = _a.className, chart = _a.chart, color = _a.color, icon = _a.icon, values = _a.values, rest = tslib_es6.__rest(_a, ["className", "chart", "color", "icon", "values"]);
    return (React.createElement(CCard.CCard, tslib_es6.__assign({ className: className }, rest, { ref: ref }),
        React.createElement(CCardHeader.CCardHeader, { className: index.default('position-relative d-flex justify-content-center align-items-center', (_b = {},
