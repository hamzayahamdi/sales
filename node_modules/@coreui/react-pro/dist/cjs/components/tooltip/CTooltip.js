...
var CTooltip = React.forwardRef(function (_a, ref) {
    ...
    var id = "tooltip".concat(React.useId());
    var _h = React.useState(false), mounted = _h[0], setMounted = _h[1];
    var _j = React.useState(visible), _visible = _j[0], setVisible = _j[1];
    var _k = usePopper.usePopper(), initPopper = _k.initPopper, destroyPopper = _k.destroyPopper, updatePopper = _k.updatePopper;
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(CConditionalPortal.CConditionalPortal, { container: container, portal: true }, mounted && (React.createElement("div", tslib_es6.__assign({ className: index.default('tooltip', 'bs-tooltip-auto', {
                fade: animation,
                show: _visible,
