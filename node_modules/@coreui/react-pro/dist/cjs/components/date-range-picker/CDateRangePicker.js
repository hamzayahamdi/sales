...
var CDateRangePicker = React.forwardRef(function (_a, ref) {
    ...
    var _1 = React.useState(calendarDate !== null && calendarDate !== void 0 ? calendarDate : null), _calendarDate = _1[0], setCalendarDate = _1[1];
    var _2 = React.useState(endDate !== null && endDate !== void 0 ? endDate : null), _endDate = _2[0], setEndDate = _2[1];
    var _3 = React.useState(maxDate !== null && maxDate !== void 0 ? maxDate : null), _maxDate = _3[0], setMaxDate = _3[1];
    var _4 = React.useState(minDate !== null && minDate !== void 0 ? minDate : null), _minDate = _4[0], setMinDate = _4[1];
    var _5 = React.useState(startDate !== null && startDate !== void 0 ? startDate : null), _startDate = _5[0], setStartDate = _5[1];
    var _6 = React.useState(visible), _visible = _6[0], setVisible = _6[1];
    var _7 = React.useState(startDate !== null && startDate !== void 0 ? startDate : null), initialStartDate = _7[0], setInitialStartDate = _7[1];
    var _8 = React.useState(endDate !== null && endDate !== void 0 ? endDate : null), initialEndDate = _8[0], setInitialEndDate = _8[1];
    var _9 = React.useState(null), inputStartHoverValue = _9[0], setInputStartHoverValue = _9[1];
    var _10 = React.useState(null), inputEndHoverValue = _10[0], setInputEndHoverValue = _10[1];
    var _11 = React.useState(valid !== null && valid !== void 0 ? valid : (invalid === true ? false : undefined)), isValid = _11[0], setIsValid = _11[1];
    var _12 = React.useState(false), selectEndDate = _12[0], setSelectEndDate = _12[1];
    ...
    var formatDate = function (date) {
        if (inputDateFormat) {
            return inputDateFormat(date instanceof Date ? new Date(date) : utils.convertToDateObject(date, selectionType));
        }
    ...
    var handleOnChange = useDebouncedCallback.useDebouncedCallback(function (value, input) {
        var date = inputDateParse
            ...
            : utils$1.getLocalDateFromString(value, locale, timepicker);
    ...
    var InputGroup = function () { return (React.createElement("div", { className: "date-picker-input-group" },
        React.createElement("input", tslib_es6.__assign({ autoComplete: "off", className: index.default('date-picker-input', {
            ...
            }), disabled: disabled }, (id && { id: utils$1.getInputIdOrName(id, range, 'start') }), (name && { name: utils$1.getInputIdOrName(name, range, 'start') }), (id &&
            !Array.isArray(id) &&
        ...
        range && (React.createElement("input", tslib_es6.__assign({ autoComplete: "off", className: index.default('date-picker-input', {
            ...
            }), disabled: disabled }, (id && { id: utils$1.getInputIdOrName(id, range, 'end') }), (name && { name: utils$1.getInputIdOrName(name, range, 'end') }), (id && !Array.isArray(id) && !name && { name: "".concat(id, "-end-date") }), { placeholder: placeholder[1], readOnly: inputReadOnly, required: required, onChange: function (event) {
                handleOnChange(event.target.value, 'end');
            }, onClick: function () { return setSelectEndDate(true); }, ref: inputEndRef }))),
        indicator &&
            (typeof indicator === 'boolean' ? (React.createElement("div", tslib_es6.__assign({ className: "date-picker-indicator" }, (disabled !== false && {
