...
var CContainer = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", tslib_es6.__assign({ className: index.default(repsonsiveClassNames.length > 0 ? repsonsiveClassNames : 'container', className) }, rest, { ref: ref }), children));
});
