...
function fetchDataForStore($pdo, $store_id, $start_date, $end_date, $search_term) {
    ...
    $sales_sql = "
        ...
        LEFT JOIN (
            ...
            SELECT 1, 18, 'Khadija el hamzaoui' UNION ALL
            ...
            SELECT 2, 14, 'RIM' UNION ALL
            SELECT 2, 15, 'Issam El Messaoudi' UNION ALL
            ...
            SELECT 6, 9, 'Halima el habboubi' UNION ALL         
...
$response = [
    ...
    'best_selling_products' => array_map(function($product) {
        return [
